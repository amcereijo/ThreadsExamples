...
public class DeadLock {
	...
	// Counter is a thread class that has two methods – IncrementBallAfterRun
	// and
	...
	class Counter implements Runnable {
		// this method increments runs variable first and then increments the
		// balls variable
		...
		public void IncrementBallAfterRun() {
			...
			synchronized (Runs.class) {
				// now acquire lock on Balls.class variable before updating
				// balls variable
	...
	// Balls class has a globally accessible data member to hold the number of
	// balls thrown so far
	static class Balls {
		public static long balls = 0;
	}

	// Runs class has a globally accessible data member to hold the number of
	// runs scored so far
	static class Runs {
